      ...
      <div className='container mx-auto px-6 py-20'>
        ...
        <div className='text-center mb-20'>
          ...
          <p className='text-gray-400 text-xl max-w-2xl mx-auto'>
            ...
            with AI-powered summaries and insights.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-3 gap-8 mb-20'>
          ...
          <div className='bg-gray-800/50 backdrop-blur-sm p-8 rounded-lg text-center'>
            ...
            <p className='text-gray-400'>
              Our AI analyzes the video content and generates a comprehensive
              summary with key points and actionable steps.
            </p>
          </div>
          ...
          <div className='bg-gray-800/50 backdrop-blur-sm p-8 rounded-lg text-center'>
            ...
            <p className='text-gray-400'>
              Chat with our AI about the video content, ask questions, and
          ...
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            <div className='space-y-6'>
              <div className='bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg'>
                ...
                <p className='text-gray-400'>
                  Get comprehensive summaries and actionable insights from any
                  YouTube video. Download them for offline access.
                </p>
              </div>
              <div className='bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg'>
                <h3 className='text-xl font-semibold text-white mb-4 flex items-center'>
                ...
                <p className='text-gray-400'>
                  Ask questions and get detailed explanations about any part of
                  the video content.
                </p>
              </div>
              <div className='bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg'>
                ...
                <p className='text-gray-400'>
                  Get clear, actionable steps to implement the knowledge from
                  your videos.
                </p>
              </div>
            </div>
        ...
        <div className='text-center mb-20'>
          ...
          <p className='text-gray-400 text-xl max-w-2xl mx-auto mb-8'>
            Ask questions, get clarifications, and explore topics deeper with
            our AI assistant that understands the video content.
          </p>
